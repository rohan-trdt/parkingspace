...
class MaskRCNNConfig(mrcnn.config.Config):
    ...
    IMAGES_PER_GPU = 1
    GPU_COUNT = 1
    NUM_CLASSES = 1 + 80  # COCO data set contains 80 classes and 1 background class
    DETECTION_MIN_CONFIDENCE = 0.6


# Filter a list of Mask-rcnn results to get only the detected cars / trucks
...
# Video file or camera to process - set this to 0 to use webcam video feed 
